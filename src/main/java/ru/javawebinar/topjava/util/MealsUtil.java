...
public class MealsUtil {
    ...
    public static List<MealTo> getTosD(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        return getFiltered(meals, meal -> DateTimeUtil.isBetween(meal.getTime(), startTime, endTime), caloriesPerDay);
    }

    public static List<MealTo> getFiltered(List<Meal> meals, Predicate<Meal> filter, int caloriesPerDay) {
